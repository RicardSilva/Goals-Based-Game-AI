...
namespace Assets.Scripts.GameManager
{
    public class GameManager : MonoBehaviour
    {
        ...
        //chest enemy
        public Dictionary<GameObject, GameObject> chestProtector;
        //private fields
        ...
        public void Start()
        {
            ...
            chestProtector = new Dictionary<GameObject, GameObject>();
            foreach (GameObject chest in chests)
            {
                ...
                {
                    var distance = (chest.transform.position - enemy.transform.position).sqrMagnitude;
                ...
                chestProtector.Add(chest, closestEnemy);
                //closestEnemy.name = "nada";
            }
            /*Debug* /
            foreach (GameObject chest in chestProtector.Keys)
            {
                Debug.Log("chest: " + chest.name + " is being protected by: " + chestProtector[chest].name);
            }
            /**/
        }
        ...
        {
            return this.CheckRange(chest, 30.0f);
        }
